        ...
        {umra.map((item: any) => {
          return (
            <div key={item.id} className='mb-4 '>
              ...
              <div
                className='my-6 ramadan-content'
                dangerouslySetInnerHTML={{ __html: item.content }}
              ></div>

              <div>
                <h1 className='text-center mb-4 text-lg md:text-xl'>
                  <strong>Idriz Travel Umra</strong> vjen me oferta per muajin e
                  bekuar te <strong>Ramazanit 2024</strong>
                </h1>

                <h2>Umre nga Shqiperia - Umre ne Ramazan 2024</h2>
