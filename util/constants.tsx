...
export const visitingPlaces = [
  {
    key: "mekke",
    items: ["Mekke - Qabja e Madhnueshme", "Mali Theur", "Arafat", "Muzdelife", "Mina", "Xhemarat", "Shpella Hira"],
  },
  {
    key: "medine",
    items: [
...
export const socialNetworks: SocialNetwork[] = [
  {
    icon: <Instagram className="h-6 w-6 mr-2   bg-rose-600 " style={{ color: "#be123c" }} />,
    key: "instagram",
